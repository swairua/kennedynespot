...
You can work locally using your own IDE. Clone the repository and push changes as needed.
...
The project can be deployed to your preferred hosting platform. Connect your domain and configure DNS settings as needed.
